...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG = "NODEJS-MOBILE";
        ...
        if( !_startedNodeAlready ) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    String nodeDir=getApplicationContext().getExternalFilesDir(null).getAbsolutePath()+"/nodejs-project";
                    Log.v(TAG, "nodeDir: " + nodeDir);
                    if (wasAPKUpdated()) {
